...
import static com.example.yeo.practice.Talkback_version_Display_Practice.Talk_writing_long_display.Dot_quiz_word;


/**
 * Created by yoonc on 2016-07-25.
 */
class Talk_reading_long_display extends View {
    int question = 1;
    ...
    public Talk_reading_long_display(Context context) {
        super(context);

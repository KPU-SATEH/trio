...
public class Mynote_service extends Service {
    ...
    MediaPlayer basicfinish,masterfinish,communicationfinish,nodata,loaddata,inputdata,datafull;
    MediaPlayer mynote[];
    int rawid[];
    ...
    public void onCreate(){
        ...
        communicationfinish = MediaPlayer.create(this, R.raw.communicationnotefinish);
    ...
    public int onStartCommand(Intent intent, int flags, int startID){
        ...
        communicationfinish.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                communicationfinish.reset();
                communicationfinish = MediaPlayer.create(Mynote_service.this,R.raw.communicationnotefinish);
            }
        });

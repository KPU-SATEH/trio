...
public class Talk_reading_long_practice extends FragmentActivity {
    Talk_reading_long_display m;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Talk_reading_long_display(this);
            ...
            public boolean onHover(View v, MotionEvent event) {
                if(m.next==false) {
                    ...
                    switch (event.getAction() & MotionEvent.ACTION_MASK) {
                        case MotionEvent.ACTION_HOVER_ENTER: //손가락 1개를 이용하여 화면을 터치하였을 경우
                        ...
                        case MotionEvent.ACTION_HOVER_EXIT:
                            ...
                            if (enter == true) {
                                ...
                                //    Intent in = new Intent(Talk_reading_long_practice.this, quiz_score.class);
                               //     startActivity(in);
                                    onBackPressed();
                                    break;
                                }
                                ...
                                startService(new Intent(Talk_reading_long_practice.this, quiz_reading_service.class));
                                m.quiz_view2_init();
                                m.invalidate();
                                m.next = false;
                            }

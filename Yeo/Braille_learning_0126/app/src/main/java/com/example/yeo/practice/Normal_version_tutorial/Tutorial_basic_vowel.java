...
public class Tutorial_basic_vowel extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_basic_vowel);
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                    ...
                    if (olddragx - newdragx > WHclass.width * (float) 0.2) {
                        ...
                        Intent intent = new Intent(Tutorial_basic_vowel.this, Tutorial_basic_final.class);
                        ...
                        startService(new Intent(this, Menu_basic_service.class));
                        Intent intent = new Intent(Tutorial_basic_vowel.this, Tutorial_basic_init.class);
                        startActivityForResult(intent, 0);

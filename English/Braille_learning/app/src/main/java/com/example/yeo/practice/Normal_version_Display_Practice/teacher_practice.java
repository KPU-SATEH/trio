...
public class teacher_practice extends FragmentActivity  {
    ...
    public void getText(String temp){
        result = temp;
        insert();
    }
    @Override
    ...
    protected void show(){
        try {
            ...
            for(int i=0;i<abc.length();i++){
                ...
                String text=str+"\n" +
                        "You entered Room number"+str+"Please teach the room number to the students";
        ...
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try{
                    ...
                    String link="http://192.168.0.2:10080/insert.php";

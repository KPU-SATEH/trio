...
public class Menu_quiz_abbreviation extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Menu_info.DISPLAY = Menu_info.DISPLAY_QUIZ_ABBREVIATION;
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP: // 손가락 1개를 화면에서 떨어트렸을 경우
                ...
                if(enter == true) {  //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 약자 및 약어 퀴즈로 접속
                    if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                        ...
                        score.sel =7;
                        Intent intent = new Intent(Menu_quiz_abbreviation.this, Menu_quiz_reading.class);
            ...
            case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                ...
                if(olddrag-newdrag>WHclass.Drag_space) {  //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                    Intent intent = new Intent(this,Menu_quiz_letter.class);

...
public class Tutorial_basic_final extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_basic_final);
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                    ...
                    if (olddragx - newdragx > WHclass.width * (float) 0.2) {
                        ...
                        Menu_basic_service.menu_page = 4;
                        startService(new Intent(this, Menu_basic_service.class));
                        Intent intent = new Intent(Tutorial_basic_final.this, Tutorial_basic_number.class);
                        startActivityForResult(intent, 0);
                        WHclass.basicprogress[3]=1;
                        ...
                        slied.slied = 2;
                        startService(new Intent(this, slied.class));
                        Menu_basic_service.menu_page = 2;
                        startService(new Intent(this, Menu_basic_service.class));
                        Intent intent = new Intent(Tutorial_basic_final.this, Tutorial_basic_vowel.class);
                        startActivityForResult(intent, 0);
                        WHclass.basicprogress[1]=1;

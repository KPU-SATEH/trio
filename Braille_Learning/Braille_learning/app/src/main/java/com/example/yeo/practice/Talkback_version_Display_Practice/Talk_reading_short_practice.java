...
public class Talk_reading_short_practice extends FragmentActivity implements SpeechRecognizeListener {
            ...
            public boolean onHover(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_HOVER_ENTER: //손가락 1개를 화면에 터치하였을 경우
                        startService(new Intent(Talk_reading_short_practice.this, Sound_Manager.class));

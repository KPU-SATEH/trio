...
public class Talk_Menu_Initial_Consonant extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_menu__initial__consonant);
        finish = MediaPlayer.create(Talk_Menu_Initial_Consonant.this, R.raw.basicfinish);

        View container = findViewById(R.id.activity_common_menu__initial__consonant);
                    ...
                    case MotionEvent.ACTION_HOVER_EXIT: // 손가락 1개를 화면에서 떨어트렸을 경우
                        ...
                        if(enter == true) { //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 기초연습으로 접속
                            if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                                ...
                                Intent intent = new Intent(Talk_Menu_Initial_Consonant.this, Talk_Braille_short_practice.class);

                    ...
                    if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                        ...
                        switch(Menu_info.MENU_QUIZ_INFO) {
                            ...
                            case 2: //문장부호퀴즈
                                ...
                                break;
                            case 3: //한칸약자퀴즈
                                Intent intent4 = new Intent(quiz_reading_manual.this, reading_long_practice.class);
                                startActivityForResult(intent4, ENTER);
                                break;
                            case 4: //어두 퀴즈
                                Intent intent5 = new Intent(quiz_reading_manual.this, reading_long_practice.class);
                                startActivityForResult(intent5, ENTER);
                                break;
                            case 5: //어미 퀴즈
                                Intent intent6 = new Intent(quiz_reading_manual.this, reading_long_practice.class);
                                startActivityForResult(intent6, ENTER);
                                break;
                            case 6: //단어 퀴즈
                                Intent intent7 = new Intent(quiz_reading_manual.this, reading_long_practice.class);

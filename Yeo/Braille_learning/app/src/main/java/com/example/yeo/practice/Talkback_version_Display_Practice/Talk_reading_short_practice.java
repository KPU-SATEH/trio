...
public class Talk_reading_short_practice extends FragmentActivity implements TextToSpeech.OnInitListener {
    /*
    3칸 이하의 점자 퀴즈를 진행하는 클래스
    */
    Talk_reading_short_display m;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Talk_reading_short_display(this);
                    ...
                    switch (event.getAction() & MotionEvent.ACTION_MASK) {
                        ...
                        case MotionEvent.ACTION_HOVER_EXIT:
                            ...
                            if (enter == true) {
                               ...
                               //     Intent in = new Intent(Talk_reading_short_practice.this, quiz_score.class);
                               //     startActivity(in);
                                    onBackPressed();
                                    break;
                                }
                                ...
                                startService(new Intent(Talk_reading_short_practice.this, quiz_reading_service.class));
                                m.quiz_view_init();
                                m.invalidate();
                                m.next = false;
                            }

...
public class Talk_Tutorial_mynote extends AppCompatActivity {
    ...
    public void startService(){
        Common_Tutorial_service.previous=6;
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(oldDragX-newDragX> WHclass.Drag_space) {  //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                        Intent quiz = new Intent(Talk_Tutorial_mynote.this, Talk_Tutorial_com.class);
                        startActivity(quiz);

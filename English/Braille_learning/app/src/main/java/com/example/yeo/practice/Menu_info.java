...
public class Menu_info {
    ...
    public static int MENU_MASTER_ABBREVIATION_WORD = 2; //약어 한 글자 연습
    public static int MENU_MASTER_ABBREVIATION_HEAD = 3; //약어 어두 연습
    public static int MENU_MASTER_ABBREVIATION_ENDING = 4; //약어 어미 연습

    public static int MENU_QUIZ_ALPHABET = 0; //알파벳
    public static int MENU_QUIZ_NUMBER = 1; //숫자 퀴즈
    public static int MENU_QUIZ_SENTENCE = 2; //문장부호퀴즈
    public static int MENU_QUIZ_ABBREVIATION_WORD= 3; //약어한칸퀴즈
    public static int MENU_QUIZ_ABBREVIATION_HEAD = 4; //어두 퀴즈
    public static int MENU_QUIZ_ABBREVIATION_ENDING = 5; //어미 퀴즈
    public static int MENU_QUIZ_WORD = 6; //단어 퀴즈
    ...
    public static int DISPLAY_ABBREVIATION_WORD=21;
    public static int DISPLAY_ABBREVIATION_HEAD=22;
    public static int DISPLAY_ABBREVIATION_ENDING=23;
    public static int DISPLAY_WORD=24; //단어연습

    public static int DISPLAY_TRANS=3; //점자번역

    public static int DISPLAY_QUIZ=4; //퀴즈
    public static int DISPLAY_QUIZ_ALPHABET=41; //초성퀴즈
    public static int DISPLAY_QUIZ_NUMBER=42; //모음퀴즈
    public static int DISPLAY_QUIZ_SENTENCE=43; //문장부호퀴즈
    public static int DISPLAY_QUIZ_ABBREVIATION_WORD=44; //약자 및 약어 퀴즈
    public static int DISPLAY_QUIZ_ABBREVIATION_HEAD=45; //글자 퀴즈
    public static int DISPLAY_QUIZ_ABBREVIATION_ENDING=46; //단어퀴즈
    public static int DISPLAY_QUIZ_WORD=47;

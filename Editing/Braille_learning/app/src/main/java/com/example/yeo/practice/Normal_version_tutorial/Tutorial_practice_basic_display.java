...
public class Tutorial_practice_basic_display extends View {
    ...
    public void MyView2_init() {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 2; j++) {
                text_1[i][j] = dot_initial.Initial_Array.get(0)[i][j];
                textname_1 = dot_initial.Initial_name.get(0);
            }

        }
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
                text_2[i][j] = dot_initial.Initial_Array.get(14)[i][j];
                textname_2 = dot_initial.Initial_name.get(14);
            }
        }
    }

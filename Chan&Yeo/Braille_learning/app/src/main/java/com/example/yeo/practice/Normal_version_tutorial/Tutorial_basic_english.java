...
public class Tutorial_basic_english extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_basic_english);
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                    ...
                    if (olddragx - newdragx > WHclass.width * (float) 0.2) {
                        ...
                        Intent intent = new Intent(Tutorial_basic_english.this, Tutorial_basic_sentence.class);
                        ...
                        startService(new Intent(this, Menu_basic_service.class));
                        Intent intent = new Intent(Tutorial_basic_english.this, Tutorial_basic_number.class);
                        startActivityForResult(intent, 0);

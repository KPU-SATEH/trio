...
public class Tutorial_master_practice extends AppCompatActivity {
    ...
    public void TTS(){
        MainActivity.TTS.speak("Good job. The current menu is the third menu of the seven " +
                "main menus, which is the experience practice menu. experience practice " +
                "menu provide experienced learning skills, such as abbreviation and word. " +
                "The size of the Braille is slightly smaller in the basic practice menu. " +
                "Now we will move to the braille translation menu. please proceed to the next " +
                "menu.", TextToSpeech.QUEUE_FLUSH, null);
        thread.start();
        touch_lock = true;

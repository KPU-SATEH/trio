    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TTS = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                TTS.speak("Check ths version. Place one finger on the screen and wait 3 second", TextToSpeech.QUEUE_FLUSH, null);
            }
        });
            ...
            if (Blind_person == true) { //시각장애인 전용버전일경우
                ...
                switch(event.getAction() & MotionEvent.ACTION_MASK) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        type = NORMAL;
                        TTS.stop();
                        TTS.speak("Checking version. Hold on a moment please.",TextToSpeech.QUEUE_FLUSH , null);
                        Timer_Reset();
                        break;
            ...
            public void run() {
                ...
                if(time_check<=10) { //3초동안 총 10번의 확인
                    ...
                    if(time_check>=25){ //모든음성이 출력되고 나면 메뉴 접속
                        ...
                        TTS.stop();
                        TTS.speak("This is Normal version.",TextToSpeech.QUEUE_FLUSH , null);
                        type=NORMAL;
                        hover_count=0;
                        normal_count=0;
                        test = true;

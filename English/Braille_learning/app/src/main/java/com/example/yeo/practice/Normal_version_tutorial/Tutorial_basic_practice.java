...
public class Tutorial_basic_practice extends AppCompatActivity {
    ...
    public void TTS(){
        MainActivity.TTS.speak("Good job. The current menu is the second menu of the seven main menus, " +
                "which is the basic practice menu. Basic courses provide basic learning, such as alphabet practice," +
                " numerical practice, and punctuation marks practice. Now we will move to the experience practice menu. " +

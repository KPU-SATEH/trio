...
public class Talk_Tutorial_translation extends AppCompatActivity {
    ...
    public void startService(){
        Common_Tutorial_service.previous=4;
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(oldDragX-newDragX> WHclass.Drag_space) {  //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                        Intent quiz = new Intent(Talk_Tutorial_translation.this, Talk_Tutorial_quiz.class);
                        startActivity(quiz);

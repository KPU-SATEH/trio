...
public class Menu_quiz_abbreviation_head extends FragmentActivity {
    ...
    public void init(){
        ...
        Menu_info.DISPLAY = Menu_info.DISPLAY_QUIZ_ABBREVIATION_HEAD;
        m = new Common_menu_display(this);
        m.setBackgroundColor(Color.rgb(22,26,44));

        setContentView(m);
        MainActivity.TTS.speak("Prefix Abbreviation Quiz", TextToSpeech.QUEUE_FLUSH, null);
    }
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP: // 손가락 1개를 화면에서 떨어트렸을 경우
                ...
                if(enter == true) { //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 글자 퀴즈로 접속
                    if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                        Menu_info.MENU_QUIZ_INFO = Menu_info.MENU_QUIZ_ABBREVIATION_HEAD;
                        Intent intent = new Intent(Menu_quiz_abbreviation_head.this, Menu_quiz_reading.class);
                        startActivityForResult(intent, Menu_info.MENU_QUIZ_ABBREVIATION_HEAD);
            ...
            case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                ...
                if(olddrag-newdrag>WHclass.Drag_space) {  //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                    ...
                    Intent intent = new Intent(this,Menu_quiz_abbreviation_word.class);
                    startActivityForResult(intent,Menu_info.MENU_QUIZ_ABBREVIATION_WORD);
                    overridePendingTransition(R.anim.fade, R.anim.hold);

    ...
    protected void show(){
        try {
            ...
            for(int i=0;i<abc_.length();i++){
                ...
                HashMap<String,String> abc_ = new HashMap<String,String>();

                abc_.put(TAG_ARRAY1,array1);
                abc_.put(TAG_ARRAY2,array2);
                abc_.put(TAG_ARRAY3,array3);
                abc_.put(TAG_ARRAY3,letter);

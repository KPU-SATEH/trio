...
public class Talk_Menu_quiz_word extends FragmentActivity {
    quiz_score score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quiz_service.finish_n = 8;
        decorView.setSystemUiVisibility( uiOption );
        setContentView(R.layout.activity_common_menu_quiz_word);
        View container = findViewById(R.id.activity_common_menu_quiz_word);
        container.setOnHoverListener(new View.OnHoverListener() {
            @Override
            public boolean onHover(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_HOVER_ENTER: //손가락 1개를 화면에 터치하였을 경우
                        startService(new Intent(Talk_Menu_quiz_word.this, Sound_Manager.class));
                    ...
                    case MotionEvent.ACTION_HOVER_EXIT: // 손가락 1개를 화면에서 떨어트렸을 경우
                        ...
                        if(enter == true) { //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 글자 퀴즈로 접속
                            if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                                ...
                                manual.choice=9;
                                score.sel =9;
                                Intent intent = new Intent(Talk_Menu_quiz_word.this, Talk_Menu_quiz_reading.class);
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_UP:  // 두번째 손가락을 떼었을 경우
                ...
                if(olddrag-newdrag>WHclass.Drag_space) {  //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                    ...
                    Intent intent = new Intent(this,Talk_Menu_quiz_letter.class);
                    startActivityForResult(intent,Menu_info.MENU_QUIZ_LETTER);
                    ...
                    Menu_detail_service.menu_page=22;

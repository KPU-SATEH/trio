...
public class Menu_Sentence extends FragmentActivity {
    ...
    public void init(){
        ...
        setContentView(m);
        MainActivity.TTS.speak("Punctuation Marks Practice", TextToSpeech.QUEUE_FLUSH, null);
    }
            ...
            case MotionEvent.ACTION_UP: // 손가락 1개를 화면에서 떨어트렸을 경우
                ...
                if(enter == true) {  //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 숫자연습으로 접속
                    if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                        ...
                        Intent intent = new Intent(Menu_Sentence.this, Braille_short_practice.class);

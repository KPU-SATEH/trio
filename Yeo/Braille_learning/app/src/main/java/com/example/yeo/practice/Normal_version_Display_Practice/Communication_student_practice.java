...
public class Communication_student_practice extends FragmentActivity {
    Communication_student_display m;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = new Communication_student_display(this);
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 화면에서 떼었을 경우
                    ...
                    if (y2drag - y1drag > WHclass.Drag_space) { //손가락 2개를 이용하여 하단으로 드래그 하는경우 정답 채점
                        ...
                        m.getData("http://192.168.0.124:10080/import.php", "87");

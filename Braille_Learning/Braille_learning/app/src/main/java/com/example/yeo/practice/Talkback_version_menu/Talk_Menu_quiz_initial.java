...
public class Talk_Menu_quiz_initial extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Menu_info.DISPLAY = Menu_info.DISPLAY_QUIZ_INIT;
            ...
            public boolean onHover(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_HOVER_ENTER: //손가락 1개를 화면에 터치하였을 경우
                        startService(new Intent(Talk_Menu_quiz_initial.this, Sound_Manager.class));
                    ...
                    case MotionEvent.ACTION_HOVER_EXIT: // 손가락 1개를 화면에서 떨어트렸을 경우
                        ...
                        if(enter == true) { //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 초성 퀴즈로 접속
                            if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                                ...
                                score.sel = 1;
                                Intent intent = new Intent(Talk_Menu_quiz_initial.this, Talk_Menu_quiz_reading.class);

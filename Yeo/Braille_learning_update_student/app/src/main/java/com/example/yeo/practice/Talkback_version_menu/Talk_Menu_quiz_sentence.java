...
public class Talk_Menu_quiz_sentence extends FragmentActivity {
    quiz_score score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_menu_quiz_sentence);

        View container = findViewById(R.id.activity_common_menu_quiz_sentence);
                    ...
                    case MotionEvent.ACTION_HOVER_EXIT: // 손가락 1개를 화면에서 떨어트렸을 경우
                        ...
                        if(enter == true) { //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 문장부호 퀴즈로 접속
                            if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                                ...
                                manual.choice=6;
                                score.sel =6;
                                Intent intent = new Intent(Talk_Menu_quiz_sentence.this, Talk_Menu_quiz_reading.class);

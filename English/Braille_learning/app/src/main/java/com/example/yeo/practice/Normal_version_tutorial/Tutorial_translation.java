...
public class Tutorial_translation extends AppCompatActivity {
    ...
    public void TTS(){
        MainActivity.TTS.speak("Good job. The current menu is the fourth menu of the seven " +
                "main menus, which is the braille translation menu. Use Speech Recognition " +
                "in the current menu. If you use Speech Recognition to speak, the word is " +
                "translated into Braille. The translated words can be learned by rubbing the screen. " +
                "Now we will move to the quiz menu. please proceed to the next menu.",

 ...
 */
public class dot_quiz_final {
    /*
     * 종성 퀴즈에서 사용되는 점자의 배열정보 및 글자정보를 관리하는 클래스
     */
    static public int finalcount = 14; // 종성 퀴즈의 갯수
    ...
    public dot_quiz_final(){
        ...
        for(int i = 0 ; i<finalcount ; i++){
            ...
            final_dot_count.add(dot_count[i]);
        }

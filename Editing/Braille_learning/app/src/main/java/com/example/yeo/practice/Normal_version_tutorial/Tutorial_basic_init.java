...
public class Tutorial_basic_init extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_basic_init);
                ...
                case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                    ...
                    newdragy = (int) event.getY();
                     if (olddragx - newdragx > WHclass.width * (float) 0.2) {
                         ...
                         Intent intent = new Intent(Tutorial_basic_init.this, Tutorial_basic_vowel.class);
                         ...
                         slied.slied = 2;
                         startService(new Intent(this, slied.class));
                         Menu_basic_service.menu_page = 7;
                         startService(new Intent(this, Menu_basic_service.class));
                         Intent intent = new Intent(Tutorial_basic_init.this, Tutorial_basic_abbreviation.class);
                         startActivityForResult(intent, 0);

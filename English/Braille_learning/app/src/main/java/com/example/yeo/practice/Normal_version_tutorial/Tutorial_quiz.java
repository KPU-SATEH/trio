...
public class Tutorial_quiz extends AppCompatActivity {
    ...
    public void TTS(){
        MainActivity.TTS.speak("Good job. The current menu is the fifth menu of the seven " +
                        "main menus, which is the quiz menu. You can read Braille and solve" +
                        " problems by using it. Now we will move to the vocabulary menu. " +
                        "please proceed to the next menu.",TextToSpeech.QUEUE_FLUSH, null);
        thread.start();
        touch_lock = true;
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_POINTER_UP:
                    ...
                    if (oldDragX - newDragX > WHclass.Drag_space) {  //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                        Intent quiz = new Intent(Tutorial_quiz.this, Tutorial_mynote.class);
                        startActivity(quiz);

...
public class Menu_abbreviation_ending extends FragmentActivity {
    ...
    public void init(){
        ...
        Menu_info.DISPLAY = Menu_info.DISPLAY_ABBREVIATION_ENDING;
        m = new Common_menu_display(this);
        m.setBackgroundColor(Color.rgb(22,26,44));

        setContentView(m);
        MainActivity.TTS.speak("Suffix Abbreviation Practice", TextToSpeech.QUEUE_FLUSH, null);
    }
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP: // 손가락 1개를 화면에서 떨어트렸을 경우
                ...
                if(enter == true) {       //손가락 1개를 떨어트린 x,y좌표 지점에 다시 클릭이 이루어진다면 글자 연습으로 접속
                    if (posx2 < posx1 + WHclass.Touch_space && posx2 > posx1 - WHclass.Touch_space && posy1 < posy2 + WHclass.Touch_space && posy2 > posy2 - WHclass.Touch_space) {
                        WHclass.sel = Menu_info.MENU_MASTER_ABBREVIATION_ENDING;
                        Menu_info.MENU_INFO = Menu_info.MENU_MASTER_ABBREVIATION_ENDING;
                        Intent intent = new Intent(Menu_abbreviation_ending.this, Braille_long_practice.class);
            ...
            case MotionEvent.ACTION_POINTER_UP:  // 두번째 손가락을 떼었을 경우
                ...
                if(olddrag-newdrag>WHclass.Drag_space) { //손가락 2개를 이용하여 오른쪽에서 왼쪽으로 드래그할 경우 다음 메뉴로 이동
                    ...
                    Intent intent = new Intent(this,Menu_abbreviation_head.class);
                    startActivityForResult(intent,Menu_info.MENU_MASTER_ABBREVIATION_HEAD);
                    overridePendingTransition(R.anim.fade, R.anim.hold);
